...
const MOCK_USER_DATA = {
  name: "Abdi",
  activePudo: { name: "Juba Hypermarket", addressCode: "0.-43-22", district: "Gufta" },
  parcelsReady: [
    { id: "p1", from: "Amazon UK", trackingId: "UK758493022" },
    { id: "p2", from: "AliExpress", trackingId: "CN938402199" },
  ],
  parcelsInTransit: [{ id: "p3", from: "Ebay", arrivalEstimate: "Oct 28" }],
};
  ...
  <div className={styles.container}>
    <main className={styles.scrollContainer}>
      <header className={styles.header}>
        ...
        <button className={styles.notificationIcon} aria-label="Notifications">•</button>
      </header>
      ...
      <section className={styles.section}>
        ...
        {MOCK_USER_DATA.parcelsReady.map(parcel => (
          <div key={parcel.id} className={`${styles.parcelCard} ${styles.parcelCardReady}`}>
            <div className={styles.parcelIconContainer}><IconBox /></div>
